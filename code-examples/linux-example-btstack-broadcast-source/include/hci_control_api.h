/*
* Copyright 2006-2023, Cypress Semiconductor Corporation (an Infineon company) or
...
#define HCI_CONTROL_LE_AUDIO_COMMAND_BROADCAST_DELEGATOR_START_BASS_ADV     ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x10)
#define HCI_CONTROL_LE_AUDIO_COMMAND_BROADCAST_ASSISTANT_SCAN_SOURCE        ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x11)
#define HCI_CONTROL_LE_AUDIO_COMMAND_BROADCAST_ASSISTANT_SCAN_DELEGATOR     ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x12)
#define HCI_CONTROL_LE_AUDIO_COMMAND_BROADCAST_ASSISTANT_CONNECT_DELEGATOR  ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x13)
...
#define HCI_CONTROL_LE_AUDIO_COMMAND_BROADCAST_SINK_TERMINATE_SYNC          ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x17)
#define HCI_CONTROL_LE_AUDIO_COMMAND_BROADCAST_SINK_LISTEN_TO_BROADCAST     ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x18)
#define HCI_CONTROL_LE_AUDIO_COMMAND_BROADCAST_SINK_SET_VOL                 ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x19)
#define HCI_CONTROL_LE_AUDIO_COMMAND_VOLUME_SET                             ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x1A)
#define HCI_CONTROL_LE_AUDIO_COMMAND_VOLUME_UNMUTE_RELATIVE_VOLUME_UP       ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x1B)
#define HCI_CONTROL_LE_AUDIO_COMMAND_VOLUME_UNMUTE_RELATIVE_VOLUME_DOWN     ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x1C)
...
#define HCI_CONTROL_LE_AUDIO_BROADCAST_STREAM_RSP_EVT       ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x08 )
