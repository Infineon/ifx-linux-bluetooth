...
const uint8_t gatt_database[] = 
{
    ...
    PRIMARY_SERVICE_UUID16 (HDLS_IAS, __UUID_SERVICE_IMMEDIATE_ALERT),
        ...
        CHARACTERISTIC_UUID16_WRITABLE (HDLC_IAS_ALERT_LEVEL, HDLC_IAS_ALERT_LEVEL_VALUE, __UUID_CHARACTERISTIC_ALERT_LEVEL, GATTDB_CHAR_PROP_WRITE_NO_RESPONSE, GATTDB_PERM_WRITE_CMD),
};
...
uint8_t app_gap_device_name[] = {'F', 'i', 'n', 'd', ' ', 'M', 'e', ' ', 'T', 'a', 'r', 'g', 'e', 't', '\0', };
