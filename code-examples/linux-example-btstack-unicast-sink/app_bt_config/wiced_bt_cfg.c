...
*                                   MACROS
*******************************************************************************/
#define WICED_DEVICE_NAME       "Unicast Sink"

wiced_bt_cfg_ble_scan_settings_t unicast_sink_scan_settings = 
{
...
const wiced_bt_cfg_ble_advert_settings_t unicast_sink_adv_settings = 
{
...
wiced_bt_cfg_ble_t unicast_sink_ble_cfg = 
{
    .ble_max_simultaneous_links     = 4,
    .ble_max_rx_pdu_size            = 65,

    .p_ble_scan_cfg                 = &unicast_sink_scan_settings,
    .p_ble_advert_cfg               = &unicast_sink_adv_settings,
...
wiced_bt_cfg_isoc_t unicast_sink_isoc_cfg = 
{
...
wiced_bt_cfg_gatt_t unicast_sink_gatt_cfg = 
{
    .max_db_service_modules = 0,
    .max_eatt_bearers       = 0,
};

wiced_bt_cfg_settings_t unicast_sink_cfg_settings = 
{
    .device_name    = (uint8_t *)WICED_DEVICE_NAME,
    .p_ble_cfg      = &unicast_sink_ble_cfg,
    .p_gatt_cfg     = &unicast_sink_gatt_cfg,
    .p_isoc_cfg     = &unicast_sink_isoc_cfg
};
