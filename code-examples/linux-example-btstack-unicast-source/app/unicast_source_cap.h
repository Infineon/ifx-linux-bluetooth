...
} unicast_source_device_config_t;

typedef struct
{
    wiced_bt_ga_bap_stream_config_t *stream_config;
    uint16_t num_devices;
    unicast_source_device_config_t *config_list;
} unicast_source_stream_config_t;

/******************************************************************************
 *                              FUNCTION DECLARATIONS
******************************************************************************/
void unicast_source_cap_start_streaming(unicast_source_stream_config_t *stream_config);
