...
wiced_result_t lehs_isoc_dhm_setup_cis_stream(lehs_ase_data_t *p_ase)
{
    ...
    WICED_BT_TRACE("audio_channel_location:%d, datapath_dir:%d", p_csc->audio_channel_allocation, datapath_dir);
...
void lehs_isoc_dhm_start_stream(uint16_t conn_hdl, uint8_t ase_type)
{
    ...
    audio_driver_init_pcm(WICED_BLE_ISOC_DPD_INPUT_BIT,
                          num_devices,
                          48000,    //test and develop
                          500       //test and develop
                         );
