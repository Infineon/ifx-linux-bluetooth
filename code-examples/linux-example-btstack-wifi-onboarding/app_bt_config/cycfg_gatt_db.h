...
extern uint8_t app_custom_service_wifi_ssid_password[];
extern const uint16_t app_custom_service_wifi_ssid_password_len;
extern uint8_t app_custom_service_wifi_ssid_password_char_user_description[];
extern const uint16_t app_custom_service_wifi_ssid_password_char_user_description_len;
