...
#define WICED_APP_CFG_SDP_HFP_FEATURE   (WICED_BT_HFP_HF_SDP_FEATURE_3WAY_CALLING | \
                                         ...
                                         WICED_BT_HFP_HF_SDP_FEATURE_SWB_SPEECH)
#elif (WICED_BT_HFP_HF_WBS_INCLUDED == TRUE)
#define WICED_APP_CFG_SDP_HFP_FEATURE   (WICED_BT_HFP_HF_SDP_FEATURE_3WAY_CALLING | \
                                         WICED_BT_HFP_HF_SDP_FEATURE_CLIP | \
                                         WICED_BT_HFP_HF_SDP_FEATURE_REMOTE_VOL_CTRL | \
                                         WICED_BT_HFP_HF_SDP_FEATURE_WIDEBAND_SPEECH)
#elif (WICED_BT_HFP_HF_SWBS_INCLUDED == TRUE)
#define WICED_APP_CFG_SDP_HFP_FEATURE   (WICED_BT_HFP_HF_SDP_FEATURE_3WAY_CALLING | \
                                         WICED_BT_HFP_HF_SDP_FEATURE_CLIP | \
                                         WICED_BT_HFP_HF_SDP_FEATURE_REMOTE_VOL_CTRL | \
                                         WICED_BT_HFP_HF_SDP_FEATURE_SWB_SPEECH)
...
wiced_bt_a2dp_codec_info_t bt_audio_codec_capabilities[] =
{
    ...
    {
        .codec_id = WICED_BT_A2DP_CODEC_MDU,
        .cie =
        {
            .mdu =
            {
                (A2D_MDU_IE_SAMP_FREQ_44 | A2D_MDU_IE_SAMP_FREQ_48),    /* samp_freq */
                (A2D_MDU_IE_BITRATE_MSK),                               /* bitrate */
                (A2D_MDU_IE_OBJ_USAC),                                  /* obj_type */
                (A2D_MDU_IE_CHNL_MSK),                                  /* chnl */
                (A2D_MDU_IE_VBR_MSK),                                   /* vbr */
            }
        }
    },
#endif
    ...
    {
        .codec_id = WICED_BT_A2DP_CODEC_M12,
        .cie =
        {
            .m12 =
            {
                (A2D_M12_IE_LAYER3),                                    /* layer */
                (A2D_M12_IE_CRC_MSK),                                   /* CRC */
                (A2D_M12_IE_CH_MD_MSK),                                 /* chnl */
                (A2D_M12_IE_MPF_MSK),                                   /* mpf */
                (A2D_M12_IE_SAMP_FREQ_44 | A2D_M12_IE_SAMP_FREQ_48),    /* samp_freq */
                (A2D_M12_IE_VBR_MSK),                                   /* vbr */
                (A2D_M12_IE_BITRATE_MSK)                                /* bitrate */
            }
        }
    },
#endif
        ...
        SDP_ATTR_ID(ATTR_ID_BT_PROFILE_DESC_LIST),
            SDP_ATTR_SEQUENCE_1(8),
                SDP_ATTR_SEQUENCE_1(6),
                    ...
                    SDP_ATTR_VALUE_UINT2(A2DP_VERSION_1_4),
        ...
        // SDP Record for Hands-Free Unit
            SDP_ATTR_SEQUENCE_1(75),
                ...
                SDP_ATTR_ID(ATTR_ID_BT_PROFILE_DESC_LIST), SDP_ATTR_SEQUENCE_1(8),
                    SDP_ATTR_SEQUENCE_1(6),
                        SDP_ATTR_UUID16(UUID_SERVCLASS_HF_HANDSFREE),
                        SDP_ATTR_VALUE_UINT2(WICED_BT_HFP_HF_VERSION),
