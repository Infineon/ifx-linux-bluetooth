...
#ifndef _BT_TTY_SDIO_TYPEDEFS_H
#define _BT_TTY_SDIO_TYPEDEFS_H

typedef struct circ_buf RingBuf_t;
typedef struct uart_sdio_port TS_Data_t;

#endif  /* _BT_TTY_SDIO_TYPEDEFS_H */
