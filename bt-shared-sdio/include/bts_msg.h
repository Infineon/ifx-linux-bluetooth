...
#ifndef _BT_TTY_SDIO_MESSAGE_H
#define _BT_TTY_SDIO_MESSAGE_H

/* Kernel log level */
#define BTS_ERR_SHIFT                   0
#define BTS_WARNING_SHIFT               1
#define BTS_EVENT_SHIFT                 2
#define BTS_INFO_SHIFT                  3
#define BTS_DBG_SHIFT                   4
#define BTS_TRC_SHIFT                   5

#define BTS_ERR_BIT                     (1 << BTS_ERR_SHIFT)
#define BTS_WARNING_BIT                 (1 << BTS_WARNING_SHIFT)
#define BTS_EVENT_BIT                   (1 << BTS_EVENT_SHIFT)
#define BTS_INFO_BIT                    (1 << BTS_INFO_SHIFT)
#define BTS_DBG_BIT                     (1 << BTS_DBG_SHIFT)
#define BTS_TRC_BIT                     (1 << BTS_TRC_SHIFT)

#endif  /* _BT_TTY_SDIO_MESSAGE_H */
