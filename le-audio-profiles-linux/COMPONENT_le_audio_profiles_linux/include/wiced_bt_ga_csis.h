 ...
 * @param[in] num_instances: Number of csis instances to be created.
 * @param[in] pv_ini : expected to be NULL
 */
wiced_result_t wiced_bt_ga_csis_init(uint8_t num_instances, void *pv_ini);

/** Enable CSIS server module */
void wiced_bt_ga_csis_enable_server(void);

/** Enable CSIS client module */
void wiced_bt_ga_csis_enable_client(void);
