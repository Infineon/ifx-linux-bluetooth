...
typedef gatt_intf_string_t wiced_bt_ga_string_t; /**< String structure */
...
typedef uint8_t wiced_bt_ga_mute_val_t; /**< Mute values (see #wiced_bt_ga_mute_val_e) */
...
typedef enum
{
    WICED_BT_GA_MICS_ERROR_MUTE_DISABLED = 0x80, /**< Mute disabled */
...
typedef enum
{
    WICED_BT_GA_HAS_ERROR_INVALID_OPCODE = 0x80,
    WICED_BT_GA_HAS_ERROR_WRITE_NAME_NOT_ALLOWED,
    WICED_BT_GA_HAS_ERROR_PRESET_SYNCHRONIZATION_NOT_SUPPORTED,
    WICED_BT_GA_HAS_ERROR_PRESET_OPERATION_NOT_POSSIBLE,
    WICED_BT_GA_HAS_ERROR_INVALID_PARAMETERS_LENGTH
} wiced_bt_ga_has_error_codes_t;
