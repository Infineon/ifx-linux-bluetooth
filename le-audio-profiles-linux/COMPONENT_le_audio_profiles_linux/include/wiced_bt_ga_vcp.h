...
#ifndef __WICED_BT_GA_VCP_H__
#define __WICED_BT_GA_VCP_H__
...
/** VCS Structure */
extern gatt_intf_service_methods_t vcs_methods;
 ...
 */
void wiced_bt_ga_vcp_set_change_counter (gatt_intf_service_object_t* p_service, uint8_t change_counter);
