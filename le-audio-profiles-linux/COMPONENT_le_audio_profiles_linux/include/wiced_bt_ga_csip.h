...
*
*
* @param[in]   p_set : csip set member entries to perform lock procedure
...
* @param[in]   p_data pointer : this will be return in given cb
*/
...
*
* @param[in]   p_set : csip set member entries to be locked
* @param[in]   num_instances : number of client instances sent
* @param[in]   cb : callback returned when the complete ordered access procedure is completed
* @param[in]   p_data pointer : this will be return in given cb
*/
void wiced_bt_ga_csip_start_ordered_access_procedure(wiced_bt_ga_csip_set_entry* p_set, int num_instances, wiced_bt_ordered_access_procedure_cmpl_cb cb, void *p_data);
