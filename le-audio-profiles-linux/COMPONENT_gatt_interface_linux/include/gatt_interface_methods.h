 ...
 * @param pv_ini : initialization data to be passed on to the created instance
...
wiced_result_t gatt_intf_method_create_service_instances(const struct gatt_intf_service_methods_t_ *p_methods,
    int num_instances, int object_instance_size, void *pv_ini);
 ...
 *  @param[in]  char_handle     : Attribute handle of this handle value notification.
...
/**
 *
 * Function     gatt_intf_method_send_indication
 *
 *              Send a handle value notification to a client
 *
 *  @param[in]  conn_d          : connection id
