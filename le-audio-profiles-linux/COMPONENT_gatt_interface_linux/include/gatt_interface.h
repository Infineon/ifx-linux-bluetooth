...
const wiced_bt_uuid_t *gatt_interface_get_service_uuid(gatt_intf_service_object_t *p_service);
...
const char *gatt_interface_get_service_name(gatt_intf_service_object_t *p_service);
