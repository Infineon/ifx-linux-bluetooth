...
*/
typedef wiced_result_t (*gatt_intf_service_cb_t)(uint16_t conn_id,
                                                 void *p_app_ctx,
...
typedef struct {
    ...
    uint32_t is_notifiable : 2;           /**< is characteristic notifiable */
...
typedef struct _gatt_intf_included_service_cfg_t
{
    ...
    */
     ...
     * @return
    */
    gatt_intf_service_object_t *(*set_included_instance)(gatt_intf_service_object_t *p_parent,
                                                         int num,
                                                         int handle,
...
*/
typedef struct gatt_intf_common_service_methods_t_
{
     ...
     * @param p_service[in] : GATT Service instance
     * @param pv_ini[in] : This parameter is passed on to the created object
    */
    void (*on_instance_create)(gatt_intf_service_object_t* p_service, void * pv_ini);
    ...
    */
    void (*free_instance)(gatt_intf_service_object_t* p_service);
    ...
    */
    gatt_intf_characteristic_handles_t *(*get_characteristic_handles_at_index)(
        gatt_intf_service_object_t *p_service, const gatt_intf_characteristic_info_t *p_cc, int index);
    /**
    ...
    */
     ...
     * @return: Returns the number of valid bytes in \p p_data
     */
    int (*get_nvram_server_data)(gatt_intf_service_object_t *p_service,
                                 wiced_bt_device_address_t bdaddr,
                                 uint8_t *p_data,
                                 int len);

} gatt_intf_common_service_methods_t;


typedef struct gatt_intf_server_service_methods_t_
{
    /**
    ...
    */
    wiced_bt_gatt_status_t (*read_local_attribute)(gatt_intf_service_object_t *p_service,
                                                   uint16_t conn_id,
                                                   uint16_t attr_handle,
                                                   uint16_t is_long_read,
     ...
     * @return wiced_bt_gatt_status_t
    */
    wiced_bt_gatt_status_t (*write_local_attribute)(gatt_intf_service_object_t *p_service,
                                                    uint16_t conn_id,
                                                    uint16_t attr_handle,
    ...
    wiced_bt_gatt_status_t (*notify_to_remote)(uint16_t conn_id,
                                               ...
                                               gatt_intf_attribute_t *p_char,
                                               void *p_notification);
} gatt_intf_server_service_methods_t;


typedef struct gatt_intf_client_service_methods_t_
{
    /**
     ...
     * @return wiced_bt_gatt_status_t
    */
    wiced_bt_gatt_status_t (*operation_complete)(gatt_intf_service_object_t *p_service,
                                                 wiced_bt_gatt_operation_complete_t *p_cmpl);
...
} gatt_intf_client_service_methods_t;

struct gatt_intf_service_methods_t_
{
    const gatt_intf_service_name_uuid_t *p_id;
    const gatt_intf_common_service_methods_t *p_common;
    const gatt_intf_server_service_methods_t *p_server;
    const gatt_intf_client_service_methods_t *p_client;
};
...
typedef struct
{
    wiced_bt_gatt_group_value_t group;
    wiced_bt_uuid_t included_by_uuid; /**< UUID of the service including the service pointed by \p group.service_type */
} gatt_intf_service_info_t;
...
* @param p_srv    : GATT interface service to be saved
* @return WICED_TRUE if application wants to save the service, WICED_FALSE otherwise
*/
typedef wiced_bool_t (*fn_on_service_handle_check_to_save)(void *p_app_ctx, gatt_intf_service_info_t *p_srv_info);

/**
* @brief Callback function to application to allow it to store the allocated service reference
* @param p_app_ctx : Application context to the callback function
* @param p_srv_info: GATT interface service to be stored
* @param p_service : GATT Service instance
*/
typedef void (*fn_on_service_handle_store)(void *p_app_ctx,
